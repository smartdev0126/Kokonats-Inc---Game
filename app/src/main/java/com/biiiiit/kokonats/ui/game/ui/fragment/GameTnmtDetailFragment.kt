...
//        }
        ...
        vm.gameDetail.observe(viewLifecycleOwner) { game ->
            val intro = game?.introduction
    ...
    private fun shareTournament(tournament: TournamentClass, game: Game) {
        context?.let {
            shareOnTwitter(it, it.getString(R.string.share_tournament, game.name, tournament.tournamentName), "https://game.kokonats.club", "kokonats_jp", "")
        }
    }
